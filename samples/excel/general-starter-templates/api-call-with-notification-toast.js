  ...
  content: |-
    ...
    function invokeRun() {
        ...
        return Excel.run(async (context) => {
            ...
            // Having issue a command to load the address,
...
libraries: |-
  ...
  // Syntax: "dt~library_name" for DefinitelyTyped or raw URL to d.ts location
  dt~office-js
  dt~jquery
  dt~core-js
